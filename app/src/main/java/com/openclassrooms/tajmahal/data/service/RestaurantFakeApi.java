...
public class RestaurantFakeApi implements RestaurantApi  {
    ...
    List<Review> reviews = Arrays.asList(
            ...
            new Review("Juliette Gold", "https://xsgames.co/randomusers/assets/avatars/male/78.jpg", "Service très rapide et nourriture délicieuse, nous mangeons ici chaque week-end, c'est très rapide et savoureux. Continuez ainsi!", 1),
